...
export declare const addFullStoryGradlePlugin: (appBuildGradle: string, { org, host, logLevel, logcatLevel, enabledVariants, recordOnStart, version, additionalConfigs, }: FullStoryAndroidProps) => string;
